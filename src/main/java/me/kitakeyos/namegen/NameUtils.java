...
public class NameUtils {
     ...
     *
     * @param classMappings Mappings to pull latest mappings from.
     * @param node Class to search.
     *
     * @return Parent name of class, or {@code null} if none found other than
    ...
    /**
     * Find the name of class's parent, or first parent if it has multiple
     * interfaces.
     *
     * @param classMappings Mappings to pull latest mappings from.
     * @param node Class to search.
