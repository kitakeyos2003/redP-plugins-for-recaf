...
import me.kitakeyos.namefilter.ScopeFilter;
import me.kitakeyos.namegen.NameStrategy;
...
/**
 * Name generator that delegates to the configured {@link NameStrategy} from the
 * plugin's {@link NamingPattern} value. Names that do not match the
 * {@link ScopeFilter} from the plugin's {@link NamingScope} value.
 *
 * @author Matt Coley
 */
public class NameGenerator {
    ...
    /**
     * @param controller Controller to pull classes from.
     * @param plugin Plugin instance with config to pull.
     * @param packageOverride Package name to put classes into. Must be
     * {@code null} to keep existing package structures.
     */
    public NameGenerator(Controller controller, RedPlugin plugin, String packageOverride, Processor processor) {
        this.scopeFilter = plugin.namingScope.createFilter(plugin);
        this.namingStrategy = plugin.namingPattern.createStrategy(controller, plugin, processor);
        this.packageOverride = packageOverride;
    }

    /**
     * @return {@code true} when the name generation implementation is safe to
     * be executed with multiple threads.
     */
     ...
     *
     * @return New internal name, or {@code null} if the naming scope does not
     * apply to the class.
     */
     ...
     *
     * @return New name, or {@code null} if the naming scope does not apply to
     * the field.
     */
    ...
    /**
     * @param owner Class defining the method.
    ...
    /**
     * @param declaring Method declaring the variable.
     * @param local Variable to rename.
     *
     * @return New name, or {@code null} if the naming scope does not apply to
     * the variable.
     */
